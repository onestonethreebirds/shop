 ...
 */
function login() {
    return location.href = "http://sso.supermarket.com/page/login";
}
function regist() {
    return location.href = "http://sso.supermarket.com/page/register";
}
...
function search(a) {
    var b = "http://search.supermarket.com/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
